...
function Calendar(inputObj, dateFormatStyle, beginDate, endDate, lang, type) {   
  ...
  this.endDate = "2040-01-01".toDate();
...
Calendar.prototype.draw = function() {   
  ...
  if("d" == this.type){
	...
	lis += "<li id='selectCurrent' style='width:45%;' title='Today'>" + Calendar.language.today[this.lang][0] +"</li>";
  	...
  	lis += "</div>";//close calendarBody
	lis += "<div class='calendarBottom'><ul>";
	lis += "<li id='emptyCalendar' style='width:27%;' title='Clear'>" + Calendar.language.clear[1] +"</li>";
	lis += "<li id='selectCurrent' style='width:45%;' title='Current Month'>" + Calendar.language.today[1][1] +"</li>";
  }
  
  lis += "<li id='closeCalendar' style='width:27%;' title='Close'>" + Calendar.language.close[1] +"</li>";
...
document.write('<div id="calendarPanel" style="position:absolute;visibility:hidden;z-index:9999;background-color:#FFFFFF;font-size:12px;width:40px;height:110px;">');
